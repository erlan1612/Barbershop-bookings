      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="mt-8">
          {isLoading && masters.length === 0 && (
             <div className="flex gap-3 overflow-x-auto px-3 pb-4 md:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 md:overflow-visible md:pb-0">
          ...
          {!isLoading && !isError && filtered.length > 0 && (
            <div className="relative">
              ...
              <div
                ...
                className="flex snap-x snap-mandatory gap-3 overflow-x-auto px-3 pb-4 scroll-smooth md:grid md:grid-cols-3 md:overflow-visible md:pb-0 lg:grid-cols-4 xl:grid-cols-5"
              >
