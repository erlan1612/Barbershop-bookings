...
**URL вашего API:** `https://barbershop-bookings.onrender.com`

### Шаг 5: Проверьте работоспособность

Откройте в браузере:
- Health check: `https://barbershop-bookings.onrender.com/api/health`
- Ready check: `https://barbershop-bookings.onrender.com/api/ready`
- Swagger docs: `https://barbershop-bookings.onrender.com/api/docs`
